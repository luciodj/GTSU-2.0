 ...
 * Label: DroidSans_Bold_36
 * Description:  Height: 43 pixels, 2 bits per pixel, Range: '0' to '9'
 ***********************************/
#if defined(GFX_CONFIG_FONT_PROG_SPACE_ENABLE) && (__XC16_VERSION__ >= 1011)
#ifndef GFX_CONFIG_FONT_PACKED_ENABLE
extern GFX_FONT_SPACE char __DroidSans_Bold_36[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char __DroidSans_Bold_36[] __attribute__((section("grc_text")));
#endif
#else
extern GFX_FONT_SPACE char __DroidSans_Bold_36[] __attribute__((aligned(2)));
#endif

const GFX_RESOURCE_HDR DroidSans_Bold_36 = 
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_FONT | GFX_RESOURCE_COMP_NONE),
    .ID = 0x0000,
    .resource.font.location.progByteAddress = (GFX_FONT_SPACE char *) __DroidSans_Bold_36,
    ...
    .resource.font.header.height = 0x002B,
};
