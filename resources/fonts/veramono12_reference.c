...
extern GFX_FONT_SPACE char __VeraMono_12[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char __VeraMono_12[] __attribute__((section("grc_text")));
#endif
#else
extern GFX_FONT_SPACE char __VeraMono_12[] __attribute__((aligned(2)));
#endif

const GFX_RESOURCE_HDR VeraMono_12 = 
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_FONT | GFX_RESOURCE_COMP_NONE),
    .ID = 0x0000,
    .resource.font.location.progByteAddress = (GFX_FONT_SPACE char *) __VeraMono_12,
